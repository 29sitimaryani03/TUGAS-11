...
<div class="single-product-area">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <form action="{{url('shop/filter')}}" method="post">
                        @csrf 
                        <h2 class="sidebar">Nama Produk</h2>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <a href="{{url('single', $produk->id)}}">
                            <img width="400px" src="{{url('public', $produk->foto)}}" alt="">
                        </div>
                        <h2><a href="{{url('single', $produk->id)}}">{{$produk->nama}}</a></h2>
    ...
    <!-- Slider -->
    <script type="{{url('public')}}/text/javascript" src="{{url('public')}}/js/bxslider.min.js"></script>
	<script type="{{url('public')}}text/javascript" src="{{url('public')}}/js/script.slider.js"></script>
  </body>
</html>